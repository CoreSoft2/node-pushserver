...
app.post('/unsubscribe', function (req, res) {
    ...
    if (config.get('apitoken') == deviceInfo.apiToken && data.user) {
        push.unsubscribeUser(data.user);
    } else if (config.get('apitoken') == deviceInfo.apiToken && data.token) {
...
app.post('/send', function (req, res) {
    ...
    if (config.get('apptoken') == deviceInfo.appToken){
